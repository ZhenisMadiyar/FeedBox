...
public class MyFeedBackAdapter extends BaseAdapter {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            view = new ViewHolder();
            convertView = inflater.inflate(R.layout.my_feedback_item, null);
            view.title = (TextView) convertView.findViewById(R.id.textViewTitleMyFeedback);
            view.desc = (TextView) convertView.findViewById(R.id.textViewDescMyFeedback);
            view.created = (TextView) convertView.findViewById(R.id.textViewCreatedMyFeedback);
            view.imageView = (ImageView) convertView.findViewById(R.id.imageViewMyFeedback);
