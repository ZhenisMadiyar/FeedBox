...
public class MyFeedBackAdapter extends BaseAdapter {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            view = new ViewHolder();
            convertView = inflater.inflate(kz.smf.almaty.feedbook.R.layout.my_feedback_item, null);
            view.title = (TextView) convertView.findViewById(kz.smf.almaty.feedbook.R.id.textViewTitleMyFeedback);
            view.desc = (TextView) convertView.findViewById(kz.smf.almaty.feedbook.R.id.textViewDescMyFeedback);
            view.created = (TextView) convertView.findViewById(kz.smf.almaty.feedbook.R.id.textViewCreatedMyFeedback);
            view.imageView = (ImageView) convertView.findViewById(kz.smf.almaty.feedbook.R.id.imageViewMyFeedback);
