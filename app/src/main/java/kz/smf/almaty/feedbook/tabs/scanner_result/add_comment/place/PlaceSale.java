...
public class PlaceSale extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(kz.smf.almaty.feedbook.R.layout.place_sale);

        getActionBar().setTitle("Скидка");
        getActionBar().setHomeButtonEnabled(true);
        getActionBar().setDisplayHomeAsUpEnabled(true);

        listViewSale = (ListView) findViewById(kz.smf.almaty.feedbook.R.id.listViewSale);
    ...
    private class SaleCustomAdapter extends BaseAdapter {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                view = new ViewHolder();
                convertView = inflater.inflate(kz.smf.almaty.feedbook.R.layout.item_place_sale, null);
                view.saleTV = (TextView) convertView.findViewById(kz.smf.almaty.feedbook.R.id.textViewSale);
